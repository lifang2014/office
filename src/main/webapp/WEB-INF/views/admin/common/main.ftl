...
<head>
    <meta charset="utf-8" />
    <title>后台管理系统</title>
    <link rel="stylesheet" type="text/css" href="${base }/resources/back/css/admin-all.css" />
    <link rel="stylesheet" type="text/css" href="${base }/resources/back/css/base.css" />
    <link rel="stylesheet" type="text/css" href="${base }/resources/back/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="${base }/resources/back/css/jquery-ui-1.8.22.custom.css" />
    <script type="text/javascript" src="${base }/resources/back/js/jquery-1.7.2.js"></script>
    <script type="text/javascript" src="${base }/resources/back/js/jquery-ui-1.8.22.custom.min.js"></script>
    <script type="text/javascript" src="${base }/resources/back/js/index.js"></script>
</head>
<body>
    <div class="warp">
        <!--头部开始-->
