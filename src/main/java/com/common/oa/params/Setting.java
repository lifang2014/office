...
public class Setting implements Serializable {
	...
	public static final String M_SPLIT_FH = ";";
	
	public static final String M_SPLIT_DH = ",";
	
	private XMLConfig admin;//默认管理员
	
	private XMLConfig menu;//系统内置菜单
	
	private XMLConfig subfix;//请求地址后缀

	private XMLConfig split;//XML内容分割符

	private XMLConfig boolInit;//是否开启初始化功能

	private XMLConfig company;//默认公司
	...
	public void setAdmin(XMLConfig admin) {
		this.admin = admin;
	}

	public XMLConfig getMenu() {
		return menu;
	}

	public void setMenu(XMLConfig menu) {
		this.menu = menu;
	}

	public XMLConfig getSubfix() {
		return subfix;
	}

	public void setSubfix(XMLConfig subfix) {
		this.subfix = subfix;
	}

	public XMLConfig getSplit() {
		return split;
	}

	public void setSplit(XMLConfig split) {
		this.split = split;
	}

	public XMLConfig getBoolInit() {
		return boolInit;
	}

	public void setBoolInit(XMLConfig boolInit) {
		this.boolInit = boolInit;
	}

	public XMLConfig getCompany() {
		return company;
	}

	public void setCompany(XMLConfig company) {
		this.company = company;
	}

	public XMLConfig getInitSecurity() {
		return initSecurity;
	}
